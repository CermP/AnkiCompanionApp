...
2. Lancez **CardsCompanionApp** (macOS) ou **CardsCompanion** (Windows)
...
1. Clonez ce repo
2. Ouvrez `CardsCompanionApp.xcodeproj` dans Xcode
3. Build & Run (⌘R)
...
4. `python -m PyInstaller --onefile --windowed --name CardsCompanion cards_companion.py`
5. L'exécutable se trouve dans `dist/CardsCompanion.exe`
